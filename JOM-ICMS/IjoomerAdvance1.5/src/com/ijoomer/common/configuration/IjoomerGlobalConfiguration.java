            ...
            protected Void doInBackground(Void... params) {
                ...
                if (validateResponse(iw.getJsonObject())) {
                    ...
                    try {
                        ...
                        try {
                            androidQuery.download(object.getString("defaultAvatar"), new File("/mnt/sdcard/tempMale.png"), new AjaxCallback<File>() {
                                @Override
                        ...
                        try {
                            androidQuery.download(object.getString("defaultAvatarFemale"), new File("/mnt/sdcard/tempFemale.png"), new AjaxCallback<File>() {
                                @Override
                                public void callback(String url, File object, AjaxStatus status) {
                                    super.callback(url, object, status);
                        ...
                        try {
                            if (object.has("default_landing_screen")) {
                                ...
                                SmartApplication.REF_SMART_APPLICATION.writeSharedPreferences(SP_LAST_ACTIVITY_INTENT, defaultScreen.toString());
