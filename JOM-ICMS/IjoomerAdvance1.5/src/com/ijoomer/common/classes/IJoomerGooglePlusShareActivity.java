...
public class IJoomerGooglePlusShareActivity extends IjoomerSuperMaster implements ConnectionCallbacks, OnConnectionFailedListener {
	...
	public void initComponents() {
		...
		mPlusClientBuilder.setVisibleActivities("http://schemas.google.com/AddActivity", "http://schemas.google.com/BuyActivity");
	...
	private void getIntentData() {
		...
		IN_SHARE_MESSAGE = getIntent().getStringExtra("IN_SHARE_MESSAGE") != null ? getIntent().getStringExtra("IN_SHARE_MESSAGE") : getString(R.string.k2_checkout);
	}
