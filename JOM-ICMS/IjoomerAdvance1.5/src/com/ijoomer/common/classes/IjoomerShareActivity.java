...
public class IjoomerShareActivity extends IjoomerSuperMaster {
    ...
    private void onFacebook(String message) {
        try {
            loadNew(FacebookSharingActivity.class, IjoomerShareActivity.this, true, "IN_SHARE_CAPTION", IN_SHARE_CAPTION, "IN_SHARE_CAPTION", IN_SHARE_CAPTION, "IN_SHARE_DESCRIPTION", IN_SHARE_DESCRIPTION, "IN_SHARE_SHARELINK", IN_SHARE_SHARELINK,
                    "IN_SHARE_THUMB", IN_SHARE_THUMB, "IN_SHARE_MESSAGE", message == null ? "" : message);
        } catch (Throwable e) {
            e.printStackTrace();
        }
        finish();
    ...
    private void onTwitter(String message) {
        try {
            loadNew(IJoomerTwitterShareActivity.class, IjoomerShareActivity.this, true, "IN_TWIT_MESSAGE", message == null ? "" : message + " \n " + IN_SHARE_SHARELINK, "IN_TWIT_IMAGE", IN_SHARE_THUMB);
        } catch (Throwable e) {
            e.printStackTrace();
        }
    }
    ...
    private void onGoolePlus(String message) {
        try {
            loadNew(IJoomerGooglePlusShareActivity.class, IjoomerShareActivity.this, true, "IN_SHARE_LINK", IN_SHARE_SHARELINK, "IN_SHARE_MESSAGE", message);
        } catch (Throwable e) {
            e.printStackTrace();
        }
    }
