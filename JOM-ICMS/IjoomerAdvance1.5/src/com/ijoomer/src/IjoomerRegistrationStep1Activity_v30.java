...
public class IjoomerRegistrationStep1Activity_v30 extends IjoomerRegistrationMaster {
	...
	public void initComponents() {
		...
		txtChange = (IjoomerTextView) findViewById(R.id.txtChange);
	...
	public void setActionListeners() {
		...
		txtChange.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (selectedImagePath.contains("Female")) {
					selectedImagePath = IjoomerGlobalConfiguration.getDefaultAvatar();
					imgUser.setImageBitmap(decodeFile(selectedImagePath));

				} else {
					selectedImagePath = IjoomerGlobalConfiguration.getDefaultAvatarFemale();
					imgUser.setImageBitmap(decodeFile(selectedImagePath));
		...
		btnContinue.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View paramView) {
				...
				if (validationFlag) {
					...
					new IjoomerRegistration(IjoomerRegistrationStep1Activity_v30.this).signUpNewUser(selectedImagePath, edtName.getText().toString().trim(), edtUserName.getText()
						...
						public void onCallComplete(int responseCode, String errorMessage, ArrayList<HashMap<String, String>> data1, Object data2) {
							if (responseCode == 200) {
								loadNew(IjoomerRegistrationStep2Activity.class, IjoomerRegistrationStep1Activity_v30.this, false);
							} else {
			...
			public void onCallComplete(int responseCode, String errorMessage, ArrayList<HashMap<String, String>> data1, Object data2) {
				if (responseCode == 200) {
					if (data1 != null) {
						...
						spnRegistrationType.setAdapter(new IjoomerUtilities.MyCustomAdapter(IjoomerRegistrationStep1Activity_v30.this, profileTypes));
		...
		if (str.contains(getString(R.string.terms_n_condition_second))) {
			ssb.setSpan(new IjoomerSpannable(Color.parseColor(getString(R.color.blue)), true) {
				...
				public void onClick(View widget) {
					final SeekBar proSeekBar = IjoomerUtilities.getLoadingDialog(getString(R.string.dialog_loading_register_user_profile_type));
					new IjoomerUsersDataProvider(IjoomerRegistrationStep1Activity_v30.this).getTermsNCondition(IjoomerGlobalConfiguration.getTermsObject(), new WebCallListener() {
