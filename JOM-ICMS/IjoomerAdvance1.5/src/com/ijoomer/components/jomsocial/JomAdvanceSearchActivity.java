        ...
        try{
            ...
            spCriteria.setOnItemSelectedListener(new OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> arg0,
                    ...
                    if(formData.get(arg2).get(TYPE).equals("select") || formData.get(arg2).get(TYPE).equals("radio") || formData.get(arg2).get(TYPE).equals("checkbox")){
                        isFromSelect = true;
            ...
            btnSearch.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    selectedArray = makeHashMapFromSelected();
                    jomAdvancedSearch.advanceSearchPostData(operator,avatarOnly,selectedArray ,new WebCallListener() {
                        ...
                        public void onCallComplete(int responseCode, String errorMessage,
                            ...
                            if (responseCode == 200) {
                                try {
                                    loadNew(JomAdvanceSearchDetailActivity.class, JomAdvanceSearchActivity.this,false,"IN_MEMBER_DATA",data1);
