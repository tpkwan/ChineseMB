...
public class JomSearchFriendFragment extends SmartFragment implements JomTagHolder {
    ...
    private ArrayList<SmartListItem> friendData= new ArrayList<SmartListItem>();
    ...
    public JomSearchFriendFragment() {
    }
    ...
    public int setLayoutId() {
        return R.layout.jom_search_friend_fragment;
    }
    ...
    public void setActionListeners(View currentView) {
        ...
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for (Iterator<String> iterator = JomSearchFriendFragment.this.selectedFriends.keySet().iterator(); iterator.hasNext();) {
                    String type = iterator.next();

                    if (iterator.hasNext()) {
                        selectedFriends += JomSearchFriendFragment.this.selectedFriends.get(type) + ",";
