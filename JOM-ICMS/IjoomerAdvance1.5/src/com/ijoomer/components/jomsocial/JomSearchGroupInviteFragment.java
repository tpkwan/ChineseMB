...
public class JomSearchGroupInviteFragment extends SmartFragment implements JomTagHolder {
    ...
    private JomGroupDataProvider providerFriend;
    ...
    public JomSearchGroupInviteFragment() {
    }
    ...
    public int setLayoutId() {
        return R.layout.jom_search_friend_group_invite_fragment;
    }
    ...
    public void initComponents(View currentView) {
        ...
        providerFriend = new JomGroupDataProvider(getActivity());
    ...
    public void setActionListeners(View currentView) {
                    ...
                    if ((firstVisibleItem + visibleItemCount) >= totalItemCount && totalItemCount > 1) {
                        if(isSearchStart){
                            ...
                            if (!providerFriend.isCalling() && providerFriend.hasNextPage()) {
                                listFooterVisible();
                                providerFriend.getInviteFriendList(IN_GROUP_ID,new WebCallListener() {
        ...
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for (Iterator<String> iterator = JomSearchGroupInviteFragment.this.selectedFriends.keySet().iterator(); iterator.hasNext();) {
                    String type = iterator.next();

                    if (iterator.hasNext()) {
                        selectedFriends += JomSearchGroupInviteFragment.this.selectedFriends.get(type) + ",";
    ...
    private void getIntentData(){
        ...
        IN_GROUP_ID = getActivity().getIntent().getStringExtra("IN_GROUP_ID") != null ? getActivity().getIntent().getStringExtra("IN_GROUP_ID") :"0" ;
