...
/**
 * This Fragment Contains All Method Related To JomEventPendingFragment.
 * 
 * @author tasol
 * 
 */
@SuppressLint("ValidFragment")
public class JomEventPendingFragment extends SmartFragment implements JomTagHolder {
	...
	public JomEventPendingFragment() {
	}
	...
	public int setLayoutId() {
		return R.layout.jom_event_pending_fragment;
	}
	...
	public void initComponents(View currentView) {
		...
		providerPendingEvent = new JomEventDataProvider(getActivity());
		provider = new JomEventDataProvider(getActivity());
						...
						providerPendingEvent.getPendingEventList(new WebCallListener() {
							...
							public void onCallComplete(int responseCode, String errorMessage, ArrayList<HashMap<String, String>> data1, Object data2) {
								try {
									listFooterInvisible();
									if (responseCode == 200) {
										((JomMasterActivity) getActivity()).updateHeader(providerPendingEvent.getNotificationData());
	...
	/**
	 * This method used to get pending event.
	...
	/**
	 * This method used to prepare list pending event.
	...
	/**
	 * List adapter for pending event.
	 */
						...
						provider.eventResponse(row.get(ID), "1", new WebCallListener() {
							...
							public void onCallComplete(int responseCode, String errorMessage, ArrayList<HashMap<String, String>> data1, Object data2) {
								if (responseCode == 200) {
									...
									adapterEvent.remove(adapterEvent.getItem(position));
								} else {
									responseErrorMessageHandler(responseCode, false);
								}
