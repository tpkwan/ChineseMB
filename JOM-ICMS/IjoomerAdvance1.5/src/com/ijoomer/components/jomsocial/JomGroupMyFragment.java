...
/**
 * This Fragment Contains All Method Related To JomGroupMyFragment.
 * 
 * @author tasol
 * 
 */
@SuppressLint("ValidFragment")
public class JomGroupMyFragment extends SmartFragment implements JomTagHolder {
	...
	public void initComponents(View currentView) {
		...
		providerMyGroup = new JomGroupDataProvider(getActivity());
						...
						providerMyGroup.getMyGroupList(new WebCallListener() {
							...
							public void onCallComplete(int responseCode, String errorMessage, ArrayList<HashMap<String, String>> data1, Object data2) {
								try{
									listFooterInvisible();
									if (responseCode == 200) {
										((JomMasterActivity) getActivity()).updateHeader(providerMyGroup.getNotificationData());
	...
	/**
	 * This method used to get my group.
	...
	/**
	 * This method used to prepare list for my group.
