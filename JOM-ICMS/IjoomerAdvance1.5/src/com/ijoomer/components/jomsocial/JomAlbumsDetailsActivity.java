...
public class JomAlbumsDetailsActivity extends JomMasterActivity {
                ...
                case PICK_IMAGE_MULTIPLE:
                    ...
                    IjoomerUtilities.getConfirmDialog(getString(R.string.upload_photo), getString(R.string.photo_uploaded_with_voice), getString(R.string.yes), getString(R.string.no),
                        ...
                        public void NegativeMethod(DialogInterface dialog, int id) {
                            ...
                            startUploasPhoto(0, data.getStringExtra("data").split("\\|"), IN_ALBUM.get(ID));
                        }
                    });
                ...
                case PICK_IMAGE:
                    IjoomerUtilities.getConfirmDialog(getString(R.string.upload_photo), getString(R.string.photo_uploaded_with_voice), getString(R.string.yes), getString(R.string.no),
                        ...
                        public void NegativeMethod(DialogInterface dialog, int id) {
                            IjoomerUtilities.addToNotificationBar(getString(R.string.photo_upload_starts), getString(R.string.upload_photo),
                                    getString(R.string.photo_upload_starts));
                            startUploasPhoto(0, (getAbsolutePath(data.getData()) + "|").split("\\|"), IN_ALBUM.get(ID));
                        }
                    });
                ...
                case TAKE_IMAGE:
                    IjoomerUtilities.getConfirmDialog(getString(R.string.upload_photo), getString(R.string.photo_uploaded_with_voice), getString(R.string.yes), getString(R.string.no),
                        ...
                        public void NegativeMethod(DialogInterface dialog, int id) {
                            IjoomerUtilities.addToNotificationBar(getString(R.string.photo_upload_starts), getString(R.string.upload_photo),
                                    getString(R.string.photo_upload_starts));
                            startUploasPhoto(0, (getImagePath() + "|").split("\\|"), IN_ALBUM.get(ID));
                        }
                    });
                    break;
     ...
     */
    private void startUploasPhoto(final int index, final String[] paths, final String albumID) {

        if (index != (paths.length)) {
            new JomGalleryDataProvider(this).uploadPhoto(null, null, paths[index], albumID, new WebCallListener() {
                ...
                public void onCallComplete(final int responseCode, String errorMessage, ArrayList<HashMap<String, String>> data1, Object data2) {
                    ...
                    if (responseCode == 200) {
                        ...
                        startUploasPhoto(index + 1, paths, albumID);
                    } else {
