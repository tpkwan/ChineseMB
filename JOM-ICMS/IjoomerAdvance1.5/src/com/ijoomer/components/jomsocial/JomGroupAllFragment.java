...
/**
 * This Fragment Contains All Method Related To JomGroupAllFragment.
 * 
 * @author tasol
 * 
 */
@SuppressLint("ValidFragment")
public class JomGroupAllFragment extends SmartFragment implements JomTagHolder {
	...
	public int setLayoutId() {
		return R.layout.jom_group_all_fragment;
	}
	...
	public void initComponents(View currentView) {
		...
		providerAllGroup = new JomGroupDataProvider(getActivity());
						...
						providerAllGroup.getAllGroupList(new WebCallListener() {
							...
							public void onCallComplete(int responseCode, String errorMessage, ArrayList<HashMap<String, String>> data1, Object data2) {
								try {
									listFooterInvisible();
									if (responseCode == 200) {
										((JomMasterActivity) getActivity()).updateHeader(providerAllGroup.getNotificationData());
	...
	/**
	 * This method used to get all group.
	...
	/**
	 * This method used to prepare list all group.
