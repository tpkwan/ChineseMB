...
/**
 * This Fragment Contains All Method Related To JomEventMyFragment.
 * 
 * @author tasol
 * 
 */
@SuppressLint("ValidFragment")
public class JomEventMyFragment extends SmartFragment implements JomTagHolder {
	...
	public int setLayoutId() {
		return R.layout.jom_event_my_fragment;
	}
	...
	public void initComponents(View currentView) {
		...
		providerMyEvent = new JomEventDataProvider(getActivity());
						...
						providerMyEvent.getMyEventList(new WebCallListener() {
							...
							public void onCallComplete(int responseCode, String errorMessage, ArrayList<HashMap<String, String>> data1, Object data2) {
								try {
									listFooterInvisible();
									if (responseCode == 200) {
										((JomMasterActivity) getActivity()).updateHeader(providerMyEvent.getNotificationData());
	...
	/**
	 * This method used to get my event.
	...
	/**
	 * This method used to prepare list my event.
