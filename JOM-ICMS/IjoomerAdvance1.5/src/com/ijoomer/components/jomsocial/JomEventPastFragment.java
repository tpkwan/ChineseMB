...
/**
 * This Fragment Contains All Method Related To JomEventPastFragment.
 * 
 * @author tasol
 * 
 */
@SuppressLint("ValidFragment")
public class JomEventPastFragment extends SmartFragment implements JomTagHolder {
	...
	public int setLayoutId() {
		return R.layout.jom_event_past_fragment;
	}
	...
	public void initComponents(View currentView) {
		...
		providerPastEvent = new JomEventDataProvider(getActivity());
						...
						providerPastEvent.getPastEventList(IN_GROUP_ID, new WebCallListener() {
							...
							public void onCallComplete(int responseCode, String errorMessage, ArrayList<HashMap<String, String>> data1, Object data2) {
								try {
									listFooterInvisible();
									if (responseCode == 200) {
										((JomMasterActivity) getActivity()).updateHeader(providerPastEvent.getNotificationData());
	...
	/**
	 * This method used to get past event.
	...
	/**
	 * This method used to prepare list past event.
